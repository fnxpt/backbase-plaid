...
public class LinkController implements LinkApi {
    ...
    /**
     * sends a request for the access token using a parsed request and returns and entity that can be stored in a database
     * @param setAccessTokenRequest  (optional) contains the request body for fetching the access token, the body contains the public key
     * @return http response idndicating the success of the call
     */
    @Override
