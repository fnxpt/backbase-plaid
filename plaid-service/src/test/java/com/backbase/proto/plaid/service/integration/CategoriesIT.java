...
public class CategoriesIT extends TestMockServer {
    ...
    public void testCategoriesParentsOnly() {
        ...
        Category category1 = new Category().id("10000000").name("Bank Fees").type(Category.TypeEnum.EXPENSE).uniqueName("Bank Fees");
        Category category2 = new Category().id("11000000").name("Cash Advance").type(Category.TypeEnum.EXPENSE).uniqueName("Cash Advance");
        Category category3 = new Category().id("12000000").name("Community").type(Category.TypeEnum.EXPENSE).uniqueName("Community");
